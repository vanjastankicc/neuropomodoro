...
Taken from the NeuroTechX BCI workshop:
https://github.com/NeuroTechX/bci-workshop
MIT licensed, see LICENSES/bci-workshop-LICENSE for the full text.

Created on Fri May 08 15:34:59 2015
@author: Cassani

Modified for this project: the notch filter is set to 50 Hz (European mains)
instead of the original 60 Hz. If your mains is 60 Hz, change the band back
to [55, 65] and record your calibration again.
"""
